-- ══════════════════════════════════════════════════════════════════════════════
-- BoomRider — Fix Order Settlement Wallet Distribution & Identity Resolution
-- ══════════════════════════════════════════════════════════════════════════════

BEGIN;

-- ── 1. Update internal settlement RPC: resolve rider and merchant via COALESCE ──
...
BEGIN
  ...
  -- Fallback 1: resolve riderUserId from riders table using COALESCE(user_id, data->>'userId')
  ...
  -- Fallback 2: look up merchant from restaurants table using COALESCE(owner_id, data->>'ownerId')
